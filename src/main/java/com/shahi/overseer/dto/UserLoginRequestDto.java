package com.shahi.overseer.dto;
...
public class UserLoginRequestDto {
	...
	@Schema(requiredMode = RequiredMode.REQUIRED, example = "aranwarez@gmail.com", description = "email-id associated with user account already created in the system")
